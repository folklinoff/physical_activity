...
public class MViewModel : AndroidViewModel {

    companion object {
        private val TAG = MViewModel::class.java.getSimpleName()
    ...
    public fun readTag(tag: Tag?) {
        Coroutines.default(this@MViewModel) {
